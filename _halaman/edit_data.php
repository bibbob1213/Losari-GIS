                      ...
                      <?php if(mysqli_num_rows($query)>0){ ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      <a href="<?=url($url.'&ubah&id='.$data['id_desa'])?>" class="btn btn-primary">        
                                      
                                      <i class="material-icons ">create</i> Edit</a>

                                      <a href="<?=url($url.'&hapus&id='.$data['id_desa'])?>" class="btn btn-danger" onclick="return confirm('Hapus data?')"> <i class="material-icons ">delete_forever</i></a> </a>
                                    </td>
                                </tr>
                                <?php  } ?>
                                <?php } ?>
