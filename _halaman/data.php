      ...
      <div class="container bg-white">
                ...
                <div class="col ">
                    <div class="btn-group w-100 " role="group">
                        <a href="<?=url('data')?>" type="button" class="btn btn btn-primary  active" >Data 1</a>
                        ...
                        <a href="<?=url('data_kt')?>"type="button" class="btn btn btn-primary ">Data 4</a>
                    </div>
                </div>
            </div>
                    ...
                    <tbody>
                      <?php if(mysqli_num_rows($query)>0){ ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo str_replace('_', ' ',$data["nama_desa"]);?></td>
                                    <td><?php echo str_replace('.', ',',$data["luas"]);?></td>
                                  <td><?php echo str_replace('.', ',',$data["lahan_sawah"]);?></td>
                                  <td><?php echo str_replace('.', ',',$data["lahan_nonsawah"]);?></td>
